...
- Automatically creating IMG, IMD and HFE formatted CP/M disk images from a directory of PC files of 8.3 characters. HFE file are used with the [HxC Floppy Emulator](<https://hxc2001.com>).
...
- The *_Make_Sorcerer_CPM_Disk_IMG_File.btm* script file will need to be modified in the following manner:
  ...
  - Likewise, the global environment variable *CPMTOOLS* needs to point your CPMTools directory.
  ...
  - The CPMTools directory needs to be appended to your computer's global PATH environment variable. Given the comment in my prior paragraph, this might not be necessary on your computer. 
